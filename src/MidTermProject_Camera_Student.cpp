    ...
    for (size_t imgIndex = 0; imgIndex <= imgEndIndex - imgStartIndex; imgIndex++)
    {
        ...
        else if (detectorType.compare("HARRIS"))
        {
            detKeypointsHarris(keypoints, imgGray, false);
                ...
                detectorType.compare("BRISK") || 
                detectorType.compare("ORB") || 
                detectorType.compare("AKAZE") || 
                detectorType.compare("SIFT"))
                {
        ...
        {
            cout<<"Wong keypoint detector chosen. Check the name again"<<endl;
        }
        //// EOF STUDENT ASSIGNMENT
        ...
        // vector<vector<float>> neighbourhoodSize;
        if (bFocusOnVehicle)
        {
